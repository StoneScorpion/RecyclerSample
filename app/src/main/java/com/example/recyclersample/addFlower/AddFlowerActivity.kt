...
const val FLOWER_CIENTIFICO = "nombreCientifico"
...
class AddFlowerActivity : AppCompatActivity() {
    ...
    private lateinit var addFlowerCientifico: TextInputEditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addFlowerCientifico = findViewById(R.id.add_flower_cientifico)
    ...
    private fun addFlower() {
        ...
        if (addFlowerName.text.isNullOrEmpty() || addFlowerDescription.text.isNullOrEmpty()
            || addFlowerTamanio.text.isNullOrEmpty() || addFlowerTipo.text.isNullOrEmpty()
            || addFlowerCientifico.text.isNullOrEmpty() || addFlowerColor.text.isNullOrEmpty()) {
            ...
            val cientifico = addFlowerCientifico.text.toString()
            ...
            resultIntent.putExtra(FLOWER_CIENTIFICO, cientifico)
